...
export default function Header(props: Props) {
  ...
  const scrollAndCloseMenu = useCallback((selector: string) => {
    scrollToSection(selector ?? '', true, -110)
  }, [])
        ...
        <div className={`container py-20px flex justify-between items-center relative z-10 ${s.container}`}>
          ...
          <nav>
            <ul className="flex justify-between items-center">
              ...
              <li><a href="#" onClick={() => scrollAndCloseMenu('#')} className='text-white text-24px leading-28px p-15px'>Ecosystem</a></li>
              <li><a href="#" onClick={() => scrollAndCloseMenu('#')} className='text-white text-24px leading-28px p-15px'>Investors</a></li>
              <li><a href="#" onClick={() => scrollAndCloseMenu('#')} className='text-white text-24px leading-28px p-15px'>Scholars</a></li>
              <li><a href="#" onClick={() => scrollAndCloseMenu('#')} className='text-white text-24px leading-28px p-15px'>Marketplace</a></li>
