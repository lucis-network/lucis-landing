...
const Home: NextPage = () => {
  ...
  const desc = 'Xenowars is a real-time strategy Play-to-earn Video Game, next development vision is becoming Metaverse of lords. Let\'s start your adventure, get your lands, build your own country and become the KING of Xenowars!';
